define(["bootbox"], function (bootbox) {
    ...
    constructor.init = function (module) {
        module.controller("UsuarioIndexCtrl", ["$state", "$stateParams","$rootScope" ,"$scope", "UsuarioTemplateService", function ($state, $stateParams, $root,$scope, service) {
            $scope.data = {};
            $scope.ver = true;
            ...
            function init() {
                ...
                service.getPersona($root.userProfile.id).success(function (data) {
                    $scope.data.persona = data;
                    $scope.personaOriginal = data;
                });

                service.getPersona($root.userProfile.id).success(function (dataO) {
                    $scope.personaOriginal = dataO;
                });
            ...
            $scope.validarModificado = function () {
                //$scope.ver = true;

                //if($scope.data.persona.nombre !== $scope.personaOriginal.nombre ){
                //    $scope.modificado = true;
                //}
                //else {$scope.modificado = false;}
                //
                //if($scope.data.persona.apellido !== $scope.personaOriginal.apellido ){
                //    $scope.modificado = true;
                //}
                //else {$scope.modificado = false;}
                //
                //if($scope.data.persona.mail !== $scope.personaOriginal.mail ){
                //    $scope.modificado = true;
                //}
                //else {$scope.modificado = false;}
                //
                //if($scope.data.persona.telefono !== $scope.personaOriginal.telefono ){
                //    $scope.modificado = true;
                //}
                //else {$scope.modificado = false;}
                //
                //if($scope.data.persona.usuario.nombre !== $scope.personaOriginal.usuario.nombre ){
                //    $scope.modificado = true;
                //}
                //else {$scope.modificado = false;}
